                        ...
                        <div class="course-grid-top d-sm-flex d-block justify-content-between align-items-center">
                            <div class="course-filter d-block align-items-center d-sm-flex">
                                ...
                                <div class="input-box">
                                    ...
                                    <input type="text" id="search-input" placeholder="{{ __('Search Course') }}"
                                    ...
                                    <div class="card shadow-sm h-100 overflow-hidden">
                                        <div class="single-courses mt-30">
                                            <div class="courses-thumb">
                                                <a class="d-block"
                                                    href="{{ route('course_details', ['slug' => $course->slug]) }}"><img
                                                        data-src="{{ asset('assets/img/courses/thumbnails/' . $course->thumbnail_image) }}"
                                        ...
                                        @foreach ($categories as $category)
                                            <li>
                                                <input type="radio"
                                                    ...
                                                    name="category" id="{{ 'radio' . $category->id }}"
                                                    value="{{ $category->slug }}">
                                                <label
                                                    for="{{ 'radio' . $category->id }}"><span></span>{{ $category->name }}</label>
                                            </li>
                                        @endforeach
                                    </ul>
                                </div>
