  ...
  <div class="sidebar-wrapper scrollbar scrollbar-inner">
    <div class="sidebar-content">
      ...
      <ul class="nav nav-primary">
        ...
        @endif
        {{-- faq --}}
        @if (is_null($roleInfo) || (!empty($rolePermissions) && in_array('Book Management', $rolePermissions)))
        <li class="nav-item {{ request()->routeIs('admin.book_management') ? 'active' : '' }}">
          <a href="{{ route('admin.book_management', ['language' => $defaultLang->code]) }}">
            <i class="la flaticon-round"></i>
            <p>{{ __('Book Management') }}</p>
          </a>
        </li>
        @endif
