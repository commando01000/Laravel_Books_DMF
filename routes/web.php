...
Route::get('/course-enrolment/mercadopago/notify', 'FrontEnd\PaymentGateway\MercadoPagoController@notify')->name('course_enrolment.mercadopago.notify');
...
Route::prefix('/admin')->middleware('auth:admin')->group(function () {
  ...
  Route::prefix('/course-management')->middleware('permission:Course Management')->group(function () {
    ...
    Route::prefix('/course')->group(function () {
      ...
      Route::get('/{id}/curriculum', 'BackEnd\Curriculum\CourseController@curriculum')->name('admin.course_management.course.curriculum');

      Route::get('/{id}/certificate', 'BackEnd\Curriculum\CourseController@showCertificate')->name('admin.course_management.course.certificate');
    });
  ...
  // Book route start
  Route::prefix('/Book-management')->middleware('permission:Book Management')->group(function () {
    Route::get('', 'BackEnd\BookController@index')->name('admin.book_management');

    Route::post('/store-book', 'BackEnd\BookController@store')->name('admin.faq_management.store_faq');

    Route::post('/update-book', 'BackEnd\BookController@update')->name('admin.faq_management.update_faq');

    Route::post('/delete-book/{id}', 'BackEnd\BookController@destroy')->name('admin.faq_management.delete_faq');

    Route::post('/bulk-delete-book', 'BackEnd\BookController@bulkDestroy')->name('admin.faq_management.bulk_delete_faq');
  });
  // Book route end
