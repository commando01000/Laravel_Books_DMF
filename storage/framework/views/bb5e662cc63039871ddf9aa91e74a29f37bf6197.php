        ...
        <div class="card-header">
          <div class="row">
            ...
            <div class="col-lg-4 offset-lg-1 mt-2 mt-lg-0">
              <a href="<?php echo e(route('admin.course_management.create_course')); ?>" class="btn btn-primary btn-sm float-right">
                <i class="fas fa-plus"></i> <?php echo e(__('Add Course')); ?>
                          ...
                          <td>
                            <div class="dropdown">
                              ...
                              <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                <a href="<?php echo e(route('admin.course_management.edit_course', ['id' => $course->id])); ?>" class="dropdown-item">
                                  <?php echo e(__('Information')); ?>

                                </a>

                                <a href="<?php echo e(route('admin.course_management.course.modules', ['id' => $course->id, 'language' => request()->input('language')])); ?>" class="dropdown-item">
                                  <?php echo e(__('Curriculum')); ?>

                                </a>

                                <a href="<?php echo e(route('admin.course_management.course.faqs', ['id' => $course->id, 'language' => request()->input('language')])); ?>" class="dropdown-item">
                                  <?php echo e(__('FAQs')); ?>
                                ...
                                <a href="<?php echo e(route('admin.course_management.course.certificate_settings', ['id' => $course->id, 'language' => request()->input('language')])); ?>" class="dropdown-item">
                                  <?php echo e(__('Certificate Settings')); ?>

                                </a>

                                <a target="_blank" href="<?php echo e(route('admin.course_management.course.curriculum', ['id' => $course->id, 'lesson_id' => $course->lesson_id, 'language' => request()->input('language')])); ?>" class="dropdown-item">
...
<?php echo $__env->make('backend.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/anngo-hub.org/public_html/resources/views/backend/curriculum/course/index.blade.php ENDPATH**/ ?>