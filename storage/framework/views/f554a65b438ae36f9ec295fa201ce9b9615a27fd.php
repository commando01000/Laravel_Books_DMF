...
<?php $__env->startSection('style'); ?>
    <?php
        $newletterBg = !empty($newsletterData->background_image)
            ? asset('assets/img/newsletter-section/' . $newsletterData->background_image)
            : asset('assets/img/static/newsletter.jpeg');
    ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <?php echo e($secInfo['id']); ?>

    <!--====== BANNER PART START ======-->
    <section class="banner-area bg_cover lazy"
        data-bg="<?php echo e(!empty($heroInfo->background_image) ? asset('assets/img/hero-section/' . $heroInfo->background_image) : asset('assets/img/static/hero.jpeg')); ?>">
        <div class="container">
            <div class="row">
                <div class="col-lg-7">
                    <div class="banner-content">
                        ...
                        <ul>
                            <?php if(!empty($heroInfo->first_button) && !empty($heroInfo->first_button_url)): ?>
                                <li><a class="main-btn"
                                        href="<?php echo e($heroInfo->first_button_url); ?>"><?php echo e($heroInfo->first_button); ?></a></li>
                            <?php endif; ?>

                            <?php if(!empty($heroInfo->second_button) && !empty($heroInfo->second_button_url)): ?>
                                <li><a class="main-btn-2 main-btn"
                                        href="<?php echo e($heroInfo->second_button_url); ?>"><?php echo e($heroInfo->second_button); ?></a></li>
                            <?php endif; ?>
                        </ul>
                    </div>
                </div>
                            ...
                            <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="col-lg-3 col-md-6 col-sm-6">
                                    <a class="single-services text-center d-block"
                                        href="<?php echo e(route('courses', ['category' => $category->slug])); ?>">
    ...
    <?php if($secInfo->call_to_action_section_status == 1): ?>
        <section class="offer-area bg_cover pt-110 pb-120 lazy"
            <?php if(!empty($callToActionInfo)): ?> data-bg="<?php echo e(asset('assets/img/action-section/' . $callToActionInfo->background_image)); ?>" <?php endif; ?>>
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-11">
                        <div class="offer-content text-center">
                            ...
                            <ul>
                                <?php if(!empty($callToActionInfo->first_button) && !empty($callToActionInfo->first_button_url)): ?>
                                    <li><a class="main-btn"
                                            href="<?php echo e($callToActionInfo->first_button_url); ?>"><?php echo e($callToActionInfo->first_button); ?></a>
                                    </li>
                                <?php endif; ?>

                                <?php if(!empty($callToActionInfo->second_button) && !empty($callToActionInfo->second_button_url)): ?>
                                    <li><a class="main-btn-2 main-btn"
                                            href="<?php echo e($callToActionInfo->second_button_url); ?>"><?php echo e($callToActionInfo->second_button); ?></a>
                                    </li>
                                <?php endif; ?>
                            </ul>
                        </div>
                                ...
                                <div class="single-courses mt-30">
                                    <div class="courses-thumb">
                                        <a href="<?php echo e(route('course_details', ['slug' => $course->slug])); ?>" class="d-block">
                                            <img data-src="<?php echo e(asset('assets/img/courses/thumbnails/' . $course->thumbnail_image)); ?>"
                                                class="crsImage lazy" alt="image">
                                        </a>

                                        <div class="corses-thumb-title">
                                            <a class="category"
                                                href="<?php echo e(route('courses', ['category' => $course->categorySlug])); ?>"><?php echo e($course->categoryName); ?></a>
                                        </div>
                                    </div>
                                    ...
                                    <div class="courses-content">
                                        ...
                                        <div class="courses-info d-flex justify-content-between">
                                            <div class="item">
                                                <img data-src="<?php echo e(asset('assets/img/instructors/' . $course->instructorImage)); ?>"
                                                    class="lazy" alt="instructor">
                                                <p><?php echo e(strlen($course->instructorName) > 10 ? mb_substr($course->instructorName, 0, 10, 'utf-8') . '...' : $course->instructorName); ?>
                                            ...
                                            <div class="price">
                                                <?php if($course->pricing_type == 'premium'): ?>
                                                    ...
                                                    <?php if(!is_null($course->previous_price)): ?>
                                                        <span
                                                            class="pre-price"><?php echo e($currencyInfo->base_currency_symbol_position == 'left' ? $currencyInfo->base_currency_symbol : ''); ?><?php echo e($course->previous_price); ?><?php echo e($currencyInfo->base_currency_symbol_position == 'right' ? $currencyInfo->base_currency_symbol : ''); ?></span>
                                                    <?php endif; ?>
                                                <?php else: ?>
                                        ...
                                        <ul class="d-flex justify-content-center">
                                            <li><i class="fal fa-users"></i> <?php echo e($course->enrolmentCount); ?>

                                                <?php echo e(__('Students')); ?></li>
                                            ...
                                            <li><i class="fal fa-clock"></i>
                                                <?php echo e($hour == '00' ? '00' : $courseDuration->format('h')); ?>h
                                                <?php echo e($courseDuration->format('i')); ?>m</li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
    ...
    <?php if($secInfo->features_section_status == 1): ?>
        ...
        <?php else: ?>
            <section class="features-area gray-bg bg_cover  py-5 lazy">
                <div class="container-fluid">
                    <div class="features-margin pl-70 pr-70">
                        <div class="row">
                            <div class="col-lg-7">
                                <div class="section-title">
                                    <h3 class="title">التوجهات الاستراتيجية</h3>
                                </div>
                            </div>
                        </div>
                        <div class="row gy-3">
                            <?php $__currentLoopData = $features; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $feature): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="col-lg-6 col-md-6">
                                    <div class="single-features"
                                        style="background: <?php echo e('#' . $feature->background_color); ?>;">
                    ...
                    <div class="col-lg-12">
                        <div class="play-thumb">
                            <?php if(!empty($videoData)): ?>
                                <img data-src="<?php echo e(asset('assets/img/video-images/' . $videoData->image)); ?>"
    ...
    <?php if($secInfo->fun_facts_section_status == 1): ?>
        <section class="counter-area bg_cove lazy"
            <?php if(!empty($factData->background_image)): ?> data-bg="<?php echo e(asset('assets/img/fact-section/' . $factData->background_image)); ?>" <?php endif; ?>>
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-7">
                        <div class="section-title text-center">
    ...
    <?php if($secInfo->testimonials_section_status == 1): ?>
        <section class="testimonials-area pb-115 bg_cover lazy"
            <?php if(!empty($testimonialData)): ?> data-bg="<?php echo e(asset('assets/img/' . $testimonialData->testimonials_section_image)); ?>" <?php endif; ?>>
            <div class="container">
                        ...
                        <?php $__currentLoopData = $testimonials; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $testimonial): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="col-lg-12">
                                <div class="testimonials-content text-center">
                                    ...
                                    <img data-src="<?php echo e(asset('assets/img/clients/' . $testimonial->image)); ?>"
        ...
        <section class="community-area">
                    ...
                    <div class="col-lg-7">
                        <div class="community-content">
                            ...
                            <form class="subscriptionForm" action="<?php echo e(route('store_subscriber')); ?>" method="POST">
                                <?php echo csrf_field(); ?>
                                <div class="input-box">
                                    <input type="email" placeholder="<?php echo e(__('Enter Your Email Address')); ?>"
                                        name="email_id">
            ...
            <?php if(!empty($newsletterData->image)): ?>
                <div class="community-thumb d-none d-lg-block">
                    <img data-src="<?php echo e(asset('assets/img/newsletter-section/' . $newsletterData->image)); ?>" class="lazy"
                        alt="image">
                </div>
            <?php endif; ?>
        </section>
...
<?php echo $__env->make('frontend.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH G:\xampp\htdocs\anngo-hub.org\public_html\resources\views/frontend/home/index-v1.blade.php ENDPATH**/ ?>