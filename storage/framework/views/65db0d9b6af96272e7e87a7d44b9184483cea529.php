  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form id="ajaxEditForm" class="modal-form" action="<?php echo e(route('admin.course_management.course.update_faq')); ?>" method="post">
...
<?php /**PATH /var/www/anngo-hub.org/public_html/resources/views/backend/curriculum/faq/edit.blade.php ENDPATH**/ ?>