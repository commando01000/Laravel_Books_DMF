  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLongTitle"><?php echo e(__('Add Module')); ?></h5>
      ...
      <div class="modal-body">
        <form id="ajaxForm" class="modal-form create" action="<?php echo e(route('admin.course_management.course.store_module', ['id' => $course->id])); ?>" method="post">
          <?php echo csrf_field(); ?>
          ...
          <div class="form-group">
            ...
            <select name="status" class="form-control">
              <option selected disabled><?php echo e(__('Select Module Status')); ?></option>
...
<?php /**PATH /var/www/anngo-hub.org/public_html/resources/views/backend/curriculum/module/create.blade.php ENDPATH**/ ?>