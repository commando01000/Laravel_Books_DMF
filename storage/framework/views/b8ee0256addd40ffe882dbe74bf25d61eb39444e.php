        ...
        <div class="card-body">
          <div class="row">
            <div class="col-lg-8 offset-lg-2">
              <form id="heroForm" action="<?php echo e(route('admin.home_page.update_hero_section', ['language' => request()->input('language')])); ?>" method="POST" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                  ...
                  <div class="row">
                    <div class="col-lg-6">
                      <div class="form-group">
                        ...
                        <input type="url" class="form-control ltr" name="video_url" value="<?php echo e(empty($data->video_url) ? '' : $data->video_url); ?>" placeholder="Enter Video URL">
                      </div>
                    </div>
                  </div>
                <?php endif; ?>
...
<?php echo $__env->make('backend.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/anngo-hub.org/public_html/resources/views/backend/home-page/hero-section.blade.php ENDPATH**/ ?>