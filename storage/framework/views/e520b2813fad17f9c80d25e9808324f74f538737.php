<?php $__env->startSection('content'); ?>
  <div class="page-header">
    <h4 class="page-title"><?php echo e(__('Books')); ?></h4>
    ...
    <div class="col-md-12">
      <div class="card">
        <div class="card-header">
          <div class="row">
            <div class="col-lg-4">
              <div class="card-title d-inline-block"><?php echo e(__('Books')); ?></div>
            </div>
                  ...
                  <table class="table table-striped mt-3" id="basic-datatables">
                    <thead>
                      <tr>
                        ...
                        <th scope="col"><?php echo e(__('Books Name')); ?></th>
                        <th scope="col"><?php echo e(__('Books Section')); ?></th>
                    ...
                    <tbody>
                      <?php $__currentLoopData = $ads; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ad): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                          ...
                          <td>
                            <?php if($ad->resolution_type == 1): ?> مكتبة الشبكة العربية
                            <?php elseif($ad->resolution_type == 2): ?>                              مكتبة متنوعة
                            <?php else: ?>
                              728 x 90
                            <?php endif; ?>
                          </td>
...
<?php echo $__env->make('backend.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/anngo-hub.org/public_html/resources/views/backend/advertisement/index.blade.php ENDPATH**/ ?>