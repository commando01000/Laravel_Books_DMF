  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form id="ajaxForm" class="modal-form create" action="<?php echo e(route('admin.course_management.course.store_faq', ['id' => $course->id])); ?>" method="post">
          <?php echo csrf_field(); ?>
...
<?php /**PATH /var/www/anngo-hub.org/public_html/resources/views/backend/curriculum/faq/create.blade.php ENDPATH**/ ?>