    ...
    <div class="col-md-12">
      <div class="card">
        <div class="card-header">
          ...
          <a class="btn btn-info btn-sm float-right d-inline-block" href="<?php echo e(route('admin.custom_pages', ['language' => $defaultLang->code])); ?>">
        ...
        <div class="card-body">
          <div class="row">
            <div class="col-lg-8 offset-lg-2">
              ...
              <form id="pageForm" action="<?php echo e(route('admin.custom_pages.update_page', ['id' => $page->id])); ?>" method="POST">
...
<?php echo $__env->make('backend.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/anngo-hub.org/public_html/resources/views/backend/custom-page/edit.blade.php ENDPATH**/ ?>