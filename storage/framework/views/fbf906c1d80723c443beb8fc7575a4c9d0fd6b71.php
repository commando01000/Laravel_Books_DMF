...
<div class="page-header">
  <h4 class="page-title"><?php echo e(__('Book Management')); ?></h4>
  <ul class="breadcrumbs">
    ...
    <li class="nav-item">
      <a href="#"><?php echo e(__('Book Management')); ?></a>
    </li>
  </ul>
</div>
...
<?php echo $__env->make('backend.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\company\public_html\resources\views/backend/book/index.blade.php ENDPATH**/ ?>