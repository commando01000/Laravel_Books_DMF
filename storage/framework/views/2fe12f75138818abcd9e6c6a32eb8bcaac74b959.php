...
unset($__errorArgs, $__bag); ?>
                      ...
                      <p class="ml-3 mb-0 text-light">
                        <a href="https://www.attheminute.com/vapid-key-generator/" target="_blank" style="text-decoration: none;">
                          <?php echo e(__('Click Here')); ?>

                        </a> <?php echo e(__('to generate the VAPID Public Key & the VAPID Private Key') . '.'); ?>
...
<?php echo $__env->make('backend.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/anngo-hub.org/public_html/resources/views/backend/end-user/push-notification/settings.blade.php ENDPATH**/ ?>