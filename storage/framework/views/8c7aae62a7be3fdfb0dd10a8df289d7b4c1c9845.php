...
<?php $__env->startSection('content'); ?>
    <?php if ($__env->exists('frontend.partials.breadcrumb', [
        ...
        'title' => $pageHeading->courses_page_title ?? 'Courses',
                        ...
                        <div class="course-grid-top d-sm-flex d-block justify-content-between align-items-center">
                            <div class="course-filter d-block align-items-center d-sm-flex">
                                <select id="sort-type">
                                    ...
                                    <option <?php echo e(request()->input('sort') == 'ascending' ? 'selected' : ''); ?>

                                        value="ascending">
                                        <?php echo e(__('Price') . ': ' . __('Ascending')); ?>

                                    </option>
                                    <option <?php echo e(request()->input('sort') == 'descending' ? 'selected' : ''); ?>
                                ...
                                <div class="input-box">
                                    ...
                                    <input type="text" id="search-input" placeholder="<?php echo e(__('Search Course')); ?>"
                                        value="<?php echo e(!empty(request()->input('keyword')) ? request()->input('keyword') : ''); ?>">
                                </div>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <div class="card shadow-sm h-100 overflow-hidden">
                                        <div class="single-courses mt-30">
                                            <div class="courses-thumb">
                                                <a class="d-block"
                                                    href="<?php echo e(route('course_details', ['slug' => $course->slug])); ?>"><img
                                                        data-src="<?php echo e(asset('assets/img/courses/thumbnails/' . $course->thumbnail_image)); ?>"
                                            ...
                                            <div class="courses-content">
                                                ...
                                                <ul class="d-flex justify-content-center">
                                                    <li><i class="fal fa-users"></i>
                                                        <?php echo e($course->enrolmentCount . ' ' . __('Students')); ?></li>
                        ...
                        <div class="course-price-filter white-bg mt-30">
                            ...
                            <div class="input-radio-btn">
                                <ul class="radio_common-2 radio_style2">
                                    <li>
                                        <input type="radio" <?php echo e(empty(request()->input('type')) ? 'checked' : ''); ?>

                                            name="type" id="radio1" value="">
                                        <label for="radio1"><span></span><?php echo e(__('All Courses')); ?></label>
                                    </li>
                                    <li>
                                        <input type="radio" <?php echo e(request()->input('type') == 'free' ? 'checked' : ''); ?>

                                            name="type" id="radio2" value="free">
                                        <label for="radio2"><span></span><?php echo e(__('Free Courses')); ?></label>
                                    </li>
                                    <li>
                                        <input type="radio" <?php echo e(request()->input('type') == 'premium' ? 'checked' : ''); ?>
                            ...
                            <div class="course-price-filter white-bg mt-30">
                                ...
                                <div class="input-radio-btn">
                                    <ul class="radio_common-2 radio_style2">
                                        <li>
                                            <input type="radio"
                                                <?php echo e(empty(request()->input('category')) ? 'checked' : ''); ?> name="category"
                                        ...
                                        <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <li>
                                                <input type="radio"
                                                    ...
                                                    name="category" id="<?php echo e('radio' . $category->id); ?>"
                                                    value="<?php echo e($category->slug); ?>">
                                                <label
                                                    for="<?php echo e('radio' . $category->id); ?>"><span></span><?php echo e($category->name); ?></label>
                                            </li>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </ul>
                                </div>
    ...
    <form id="filtersForm" class="d-none" action="<?php echo e(route('courses')); ?>" method="GET">
        <input type="hidden" id="type-id" name="type"
            value="<?php echo e(!empty(request()->input('type')) ? request()->input('type') : ''); ?>">
        ...
        <input type="hidden" id="sort-id" name="sort"
            value="<?php echo e(!empty(request()->input('sort')) ? request()->input('sort') : ''); ?>">
...
<?php echo $__env->make('frontend.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH G:\xampp\htdocs\anngo-hub.org\public_html\resources\views/frontend/curriculum/courses.blade.php ENDPATH**/ ?>