...
class TestimonialController extends Controller
{
  ...
  public function updateImage(Request $request)
  {
    ...
    if ($request->hasFile('image')) {
      $imgName = UploadFile::update(public_path('assets/img/'), $request->file('image'), $data->testimonials_section_image);
  ...
  {
    $imageName = UploadFile::store(public_path('assets/img/clients/'), $request->file('image'));
  ...
  public function update(UpdateRequest $request)
  {
    ...
    if ($request->hasFile('image')) {
      $imageName = UploadFile::update(public_path('assets/img/clients/'), $request->file('image'), $testimonial->image);
    }
