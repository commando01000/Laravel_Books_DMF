...
class LessonContentController extends Controller
{
  ...
  public function uploadVideo(Request $request)
  {
    ...
    $videoData = UploadFile::store(public_path('assets/video/'), $request->file('video'));
  ...
  public function removeVideo(Request $request)
  {
    if (empty($request['title'])) {
      ...
      @unlink(public_path('assets/video/') . $request['title']);
  ...
  public function uploadFile(Request $request)
  {
    ...
    $fileData = UploadFile::store(public_path('assets/file/lesson-contents/'), $request->file('file'));
  ...
  public function removeFile(Request $request)
  {
    if (empty($request['title'])) {
      ...
      @unlink(public_path('assets/file/lesson-contents/') . $request['title']);
  ...
  public function downloadFile($id)
  {
    ...
    $pathToFile = public_path('assets/file/lesson-contents/') . $content->file_unique_name;
  ...
  public function destroyContent($id)
  {
    ...
    @unlink(public_path('assets/video/') . $content->video_unique_name);
    @unlink(public_path('assets/file/lesson-contents/') . $content->file_unique_name);
